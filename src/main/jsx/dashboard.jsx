                        ...
                        <ul className="nav pull-right">
                            <li className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li>
                                        <a  href="http://roybailey.biz">Profile</a>
                                    </li>
...
var StatisticsGraph = function (props) {
    return (
        <div className="span3">
            <div className="chart" data-percent={props.percent}>{props.percent}%</div>
            <div className="chart-bottom-heading">
                <span className="label label-info">{props.label}</span>
            </div>
        </div>
    );
};
...
var TaskTableRow = function (props) {
    return (
        <tr>
            <td>{props.guid}</td>
            <td>{props.name}</td>
            <td>{(props.dueDate === null) ? "" : "" + props.dueDate}</td>
            <td>{props.effort}</td>
        </tr>
    );
};
        ...
        <div className="span6">
            <div className="block">
                <div className="navbar navbar-inner block-header">
                    <div className="muted pull-left">{props.title}</div>
                    <div className="pull-right">
                        <span className="badge badge-info">{props.count}</span>
                    </div>
                </div>
                <TaskTable loader={props.loader}/>
            </div>
        </div>
    );
};
...
var Container = function (props) {
    ...
    return (
        <div className="container-fluid">
            <div className="row-fluid">
                <SideBar />
                <Content message={props.message} skip={props.skip} limit={props.limit}/>
            </div>
            <hr/>
            <footer>
